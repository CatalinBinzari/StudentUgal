...
export function testServer() {
    const request = axios.get(`${SERVER}/test/`).then(response => response.data);
    console.log(request);
    return {
        type: TEST_SERVER,
        payload: request
...
export function subscribeUser(dataToSubmit) {
    const request = axios.post(`${USER_SERVER}/subscribe`, dataToSubmit)
        .then(response => response.data);
...
export function updateUserData(dataToSubmit) {
    const request = axios.post(`${USER_SERVER}/editUser`, dataToSubmit)
        .then(response => {
